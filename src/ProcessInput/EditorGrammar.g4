...
north_cond: NORTH_COND_KEY flag EQUALS num_int (COMMA flag EQUALS num_int)* SEMICOLON north_block_message | /*epsilon*/;
south_cond: SOUTH_COND_KEY flag EQUALS num_int (COMMA flag EQUALS num_int)* SEMICOLON south_block_message | /*epsilon*/;
east_cond: EAST_COND_KEY flag EQUALS num_int (COMMA flag EQUALS num_int)* SEMICOLON east_block_message | /*epsilon*/;
west_cond: WEST_COND_KEY flag EQUALS num_int (COMMA flag EQUALS num_int)* SEMICOLON west_block_message | /*epsilon*/;
up_cond: UP_COND_KEY flag EQUALS num_int (COMMA flag EQUALS num_int)* SEMICOLON up_block_message | /*epsilon*/;
down_cond: DOWN_COND_KEY flag EQUALS num_int (COMMA flag EQUALS num_int)* SEMICOLON down_block_message | /*epsilon*/;
