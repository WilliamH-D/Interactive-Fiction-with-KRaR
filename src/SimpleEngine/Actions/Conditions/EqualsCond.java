...
public class EqualsCond extends ConditionTest {
    ...
    public boolean satisfied() {
        ...
        if (bothVars) {
            logger.logDebug("Checking EqualsCond: Check that " + lobjID + "::" + lhs + " (" + lobj.getVariable(lhs) + ") = " + robjID + "::" + rhs + " (" + robj.getVariable(rhs) + ")");
        }
        else {
            logger.logDebug("Checking EqualsCond: Check that " + lobjID + "::" + lhs + " (" + lobj.getVariable(lhs) + ") = " + rhs);
        }
